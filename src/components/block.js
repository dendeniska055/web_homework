...
import $ from "jquery";
 ...
 export const Block: FunctionComponent<BlockProps> = ({ user, event, text, time, count_likes, can_answer, level, moment }, props) => {
    ...
    return (
      <div className="row no-gutters">
        ...
        <div className="col-1">
          {moment &&
            <Link to={`/profile/${user.id}`} ><img src={moment.pictures} className="card-img ml-2" style={{ width: 40, height: 40 }} alt="" loading="lazy" /></Link>}
