        ...
        <nav className="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
          ...
          <div className="collapse navbar-collapse" id="navbarCollapse">
            <ul className="navbar-nav mr-auto">
              ...
              <li className={"nav-item" + (props.activePanel === "events" ? " active" : "")}>
                <a className="nav-link d-sm-flex d-md-block" onClick={()=>props.setModal("upload")} >
              ...
              {/* <li className={"nav-item" + (props.activePanel === "search" ? " active" : "")}>
            ...
            </ul>
            {
              ...
              <Link className="mx-3" to='/signup'>
                ...
                <button className="mr-2 btn btn-danger" onClick={logout} >Выйти</button>
            }
            <form className="form-inline mt-2 mt-md-0">
              ...
              <Link to='/search'>
                <button className="btn btn-outline-success m-0" type="submit">< Icon24Search /></button>
              </Link>
            </form>
          </div>
        </nav>
